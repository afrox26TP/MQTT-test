...
Připojení a cesty se nastavují v `.env`. Nejdůležitější proměnné jsou `MQTT_BROKER_HOST`, `MQTT_BROKER_PORT`, `MQTT_USERNAME`, `MQTT_PASSWORD`, `MQTT_TLS`, `PRESENCE_CONFIG` a `DATA_DIR`.
